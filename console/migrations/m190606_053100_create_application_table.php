...
class m190606_053100_create_application_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('application', [
            ...
            'file' => $this->string()->comment('Документы к заявке'),
            'status' => $this->smallInteger()->notNull()->defaultValue(0)->comment('Статус заявки'),
            'created_at' => $this->integer()->notNull()->comment('Дата создания заявки'),
            'updated_at' => $this->integer()->notNull()->comment('Дата обновления заявки'),
        ]);
