...
class ExpertController extends Controller
{
    ...
    /**
     * Назаначенные эксперты на конкурс
     * @return mixed
     */
    ...
    /**
     * Просмотр назаначения эксперта на конкурс
     * @param integer $id
     * @return mixed
    ...
    /**
     * Назаначение эксперта на конкурс
    ...
    /**
     * Изменение назаначения эксперта на конкурс
